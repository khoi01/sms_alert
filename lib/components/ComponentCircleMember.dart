...
class ComponentCircleMember extends StatefulWidget {
  ...
  final String?
      componentCircleId; //refer this component id (easy to find this component in the listview)
  final Color? backgroundColor;
  const ComponentCircleMember(
      {Key? key,
      required this.displayName,
      this.componentCircleId,
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text((widget.displayName?.length ?? 0) >= 7
                ? widget.displayName?.substring(0, 7) ??
